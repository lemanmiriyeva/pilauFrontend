...
/*
 * "İstehsal" bundan sonra "Lisenziya" adı altında, idxal/ixrac kimi 2 yerə
 * bölünüb: Xüsusi Lisenziya / Ümumi Lisenziya. Sahələr hələlik köhnə
 * "istehsal" sxeminin eyni surətidir (bax backend licenses/field_schema.py -
 * _XUSUSI_LISENZIYA_* / _UMUMI_LISENZIYA_*) - sonra ayrı-ayrı redaktə olunacaq.
 */
const TYPE_META = {
    xususi: {
        docType: 'xususi_lisenziya',
        title: 'Xüsusi Lisenziya',
    },
    umumi: {
        docType: 'umumi_lisenziya',
        title: 'Ümumi Lisenziya',
    },
};
...
export default function Page() {
    ...
    const typeKey = params?.type === 'umumi' ? 'umumi' : 'xususi';
    const meta = TYPE_META[typeKey];
    const DOC_TYPE = meta.docType;
    ...
    */
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            enqueueSnackbar(`${meta.title} yoxlamaya göndərildi.`, {variant: 'success'});
        ...
        return (
            ...
            <AppShell>
                ...
                >
                    ...
                    <Button
                        variant="outlined"
                        onClick={() => router.push(APP_ROUTES.ISTEHSAL_YENI)}
